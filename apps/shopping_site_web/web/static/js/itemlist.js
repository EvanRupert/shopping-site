...
var _user$project$Types$Item = F4(
	function (a, b, c, d) {
		return {name: a, description: b, price: c, imageUrl: d};
	});
...
var _user$project$ItemList$groupInto = F2(
	function (n, l) {
		var _p1 = l;
		if (_p1.ctor === '[]') {
			return {ctor: '[]'};
			...
			return {
				ctor: '::',
				_0: A2(_elm_lang$core$List$take, n, _p2),
				_1: A2(
					_user$project$ItemList$groupInto,
					n,
					A2(_elm_lang$core$List$drop, n, _p2))
			};
		}
	});
...
var _user$project$ItemList$viewGroup = function (items) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('row margin-row'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _user$project$ItemList$viewItem, items));
};
var _user$project$ItemList$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$ItemList$viewGroup,
						A2(_user$project$ItemList$groupInto, 3, model.items))),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$ItemList$itemDecoder = A5(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _user$project$ItemList$defaultItem = {name: 'Invalid', description: 'Invalid', price: 0, imageUrl: 'Invalid'};
var _user$project$ItemList$decodeJson = function (str) {
	var result = A2(
		_elm_lang$core$Json_Decode$decodeString,
		_elm_lang$core$Json_Decode$list(_user$project$ItemList$itemDecoder),
		str);
	return A2(
		_elm_lang$core$Result$withDefault,
		{
			ctor: '::',
			_0: _user$project$ItemList$defaultItem,
			_1: {ctor: '[]'}
		},
		result);
};
var _user$project$ItemList$init = function (flags) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			items: _user$project$ItemList$decodeJson(flags.payload)
		},
		{ctor: '[]'});
};
var _user$project$ItemList$main = _elm_lang$html$Html$programWithFlags(
	{
		...
		update: _user$project$ItemList$update,
...
if (typeof _user$project$ItemList$main !== 'undefined') {
    _user$project$ItemList$main(Elm['ItemList'], 'ItemList', undefined);
}
